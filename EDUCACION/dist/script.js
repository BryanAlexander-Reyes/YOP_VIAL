...
function Renderer() {
  canvasEl = document.querySelector("canvas.game");
  ...
  // Use the actual window size for consistent mobile behavior
  renderer.setSize(window.innerWidth, window.innerHeight, false);
  // Ensure the canvas CSS size matches the renderer on mobile
